...
const url = 'mongodb+srv://manhltgch17279:manhltgch17279@cluster0-6bapj.gcp.mongodb.net/test?authSource=admin&replicaSet=Cluster0-shard-0&readPreference=primary&appname=MongoDB%20Compass%20Community&ssl=true';
...
router.post('/edit',upload.single('picture'), async(req, res)=>{
    ...
    res.render('productPage', {product: result});
})
